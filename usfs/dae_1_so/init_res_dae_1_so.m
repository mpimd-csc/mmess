function [W, res0, eqn, opts, oper] = ...
    init_res_dae_1_so(eqn, opts, oper, W, T)
...
%   T          such that residual is W*T*W' (optional, defaults to identity)
%
%   Outputs:
%
%   W        restriction of W to the hidden manifold
...
if not(2 * eqn.manifold_dim == size(W, 1))
